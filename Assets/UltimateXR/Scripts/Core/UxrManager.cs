...
namespace UltimateXR.Core
{
    ...
    public sealed class UxrManager : UxrSingleton<UxrManager>
    {
        ...
        /// <summary>
        ///     Translates the LocalAvatar
        /// </summary>
        /// <param name="translation">Translation offset</param>
        public void TranslateAvatar(Vector3 translation)
        {
            TranslateAvatar(UxrAvatar.LocalAvatar, translation);
        }
        ...
        /// <summary>
        ///     Moves the local avatar to a new position on the floor, keeping the same viewing direction. The eye level is maintained. 
        /// </summary>
        /// <param name="newFloorPosition"></param>
        public void MoveAvatarTo(Vector3 newFloorPosition)
        {
            MoveAvatarTo(UxrAvatar.LocalAvatar, newFloorPosition);
        }
        ...
        /// </summary>
        /// <param name="destination">The transform position and orientation on the floor</param>
        public void MoveAvatarTo(Transform destination)
        {
            MoveAvatarTo(UxrAvatar.LocalAvatar, destination);
        }
